...
当前网络基线为协议 v40、8 个 ENet 通道。v40 新增会说话的史莱姆、三选项投票
与多页权威结果；v39 新增举盾机器人盾牌阶段快照位，并通过既有敌人动作协议
同步格挡与破盾表现；v38 新增 Host 权威的爆炸无人机投射物类型，客户端按固定
部署、飞行与爆炸三阶段合同补播；v37 新增 P3 神奇遭遇的 Host 权威逐人对白
确认、投票、结算与经济快照。v36 的测试场景
