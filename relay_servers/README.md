...
当前网络基线为协议 v49、8 个 ENet 通道。v49 新增精英持枪战斗机器人、独立紫色
弹丸类型及玩家受击来源 wire ID 18；v48 新增肉鸽地下商店的购买、出售、退出回执、
逐人私有货架快照及路线完整快照中的目标玩家商店状态；v47 新增精英战斗机器人的
独立配置、场景与动画资源合同。客户端必须同时具备对应资源、RPC表面与wire语义。
v46 将内嵌肉鸽战斗的
`PREPARED`（场景已准备）与
