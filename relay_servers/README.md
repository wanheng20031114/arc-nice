...
当前网络基线为协议 v36、8 个 ENet 通道。v36 新增测试场景 P1B 模式；原 P1
对外显示为 P1A，但稳定 key `test_arena_p1` 保持不变，P1B 使用
`test_arena_p1b`。v35 的战斗机器人枪手弹丸及玩家受击来源 wire ID 17 保持兼容；
