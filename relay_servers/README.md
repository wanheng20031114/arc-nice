...
当前网络基线为协议 v79、8 个 ENet 通道。v79 将正式塔防的通用 T 目录放置请求
升级为 canonical 建筑物品的 Host 权威付费：先扣请求者本人背包，再由共享仓库补足；
v78 Host 仍把同形状请求理解为沙盒免费放置，无法识别该正式付费语义。v78 为 P3
