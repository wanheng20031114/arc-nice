...
当前网络基线为协议 v70、8 个 ENet 通道。v70 将地下教会正式普通作战的敌人构成从
纸箱怪/持枪机器人/史莱姆 20/20/30 调整为 10/20/40，同时存活上限从 20 降为 15；
总数 70、0.2 秒生成间隔、RPC 表面、快照宽度与通道数不变。v69 新增植被桩蔓延增强科研的 wire 注册项，
