...
当前网络基线为协议 v56、8 个 ENet 通道。v56 将肉鸽“狭路相逢”的敌人组成、生成节奏、同时存活上限与红门均衡随机策略统一收归波次资源，并冻结完整波次运行时合同；v55 新增稀有宝箱私人候选、永久属性账本与逐玩家路线快照合同；v54 新增十二种消耗品资源与效果合同，
