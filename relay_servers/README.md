...
当前网络基线为协议 v48、8 个 ENet 通道。v47 新增精英战斗机器人的独立配置、场景
与动画资源合同，并继续复用既有敌人动作协议补播蓄力、冲刺和提前结束表现；v48
新增肉鸽地下商店的购买、出售、退出回执与逐人私有货架快照，路线完整快照也携带
目标玩家的商店状态。通道数保持不变，但客户端必须具备对应资源与 RPC 表面。v46 将内嵌肉鸽战斗的
`PREPARED`（场景已准备）与
