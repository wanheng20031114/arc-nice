...
当前网络基线为协议 v60、8 个 ENet 通道。v60 将肉鸽普通作战升级为按节点种子
确定性选择的带权资源池，并把完整普通作战池纳入楼层运行时合同；v59 新增测试场景 P1D 的稳定 wire
...
P1C/P1D 分别使用新 key `test_arena_p1c`/`test_arena_p1d`。
