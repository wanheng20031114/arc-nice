...
当前网络基线为协议 v64、8 个 ENet 通道。v64 登记主战机器人与 P1E 稳定 wire
模式值 8，并在既有玩家伤害确认 RPC 尾部追加 Host 确认的燃烧/减速状态位；
P1E 在原生运行视觉发布前保持不可选择。v63 新增“隐形海参”神奇遭遇、
