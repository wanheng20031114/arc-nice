...
当前网络基线为协议 v45、8 个 ENet 通道。v45 新增忍者战斗机器人的受击加速
敌人动作，并让敌人视觉状态 bit5 在该场景中表示短时加速态；客户端必须能补播
动作并从快照恢复尾影表现。同时保留 v44 引入的小葱“濒危核心”第二阶段全局
增益投票状态，以及 v43 引入的肉鸽作战简报权威状态快照与全员遮盖就绪确认；
