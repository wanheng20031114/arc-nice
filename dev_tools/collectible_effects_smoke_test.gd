...
const APPLE := preload("res://resources/config/pickups/collectible_apple.tres")
const RUBY := preload("res://resources/config/pickups/collectible_ruby.tres")
const POWER_RING := preload("res://resources/config/pickups/collectible_power_ring.tres")
const MAGIC_RING := preload("res://resources/config/pickups/collectible_magic_ring.tres")
const GOLD_WINE_CUP := preload("res://resources/config/pickups/collectible_gold_wine_cup.tres")
const TIANSHI_STAKE := preload("res://resources/config/pickups/collectible_tianshi_stake.tres")
const THUNDER_CRYSTAL := preload("res://resources/config/pickups/collectible_thunder_crystal.tres")
const FROST_CRYSTAL := preload("res://resources/config/pickups/collectible_frost_crystal.tres")
const LIFE_CRYSTAL := preload("res://resources/config/pickups/collectible_life_crystal.tres")
const MOON_AMULET := preload("res://resources/config/pickups/collectible_moon_amulet.tres")
const SWIFT_CRYSTAL := preload("res://resources/config/pickups/collectible_swift_crystal.tres")
const ADMIN_DOLL := preload("res://resources/config/pickups/collectible_admin_doll.tres")
