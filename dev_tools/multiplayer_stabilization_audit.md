...
> 2026-08-24 当前网络基线为协议 v94。应用层继续使用 CH0..CH8 九条逻辑信道；公网 Relay 的认证感知 `MultiplayerPeerExtension` 另外使用可靠 CH9 依次发布拓扑并承载 Relay 服务控制，公网 ENet 最大信道索引为 9。v94 同步敌人阵营、通用目标、Host 投射物来源，并将敌人高频连发压缩为 CH4 单次 burst、以 reliable CH5 修复活跃视觉弹体；文中的 v93、v92、v91、v90 与 v9 小节均为历史快照，不能据此判断当前协议状态。
