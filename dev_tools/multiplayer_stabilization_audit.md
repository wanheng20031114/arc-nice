...
> 2026-08-24 当前网络基线为协议 v95。应用层继续使用 CH0..CH8 九条逻辑信道；公网 Relay 的认证感知 `MultiplayerPeerExtension` 另外使用可靠 CH9 依次发布拓扑并承载 Relay 服务控制，公网 ENet 最大信道索引为 9。v95 在 CH0 新增宿主权威全局暂停、会话世代/CAS 修订和重连暂停快照，同时保留 v94 的敌人阵营、通用目标、Host 投射物来源及批量视觉弹体合同；文中的 v94、v93、v92、v91、v90 与 v9 小节均为历史快照，不能据此判断当前协议状态。
