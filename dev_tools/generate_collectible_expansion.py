...
DESIGN_ROWS = [
    ...
    design("chipped_ruby", "火星命中", "普通子弹有概率点燃敌人。", hit="burn", hit_chance=0.14, hit_damage=1, hit_duration=1.5, hit_tick=0.5),
    ...
    design("campfire_coal", "灼烧命中", "普通子弹有概率造成灼烧。", hit="burn", hit_chance=0.16, hit_damage=1, hit_duration=2.0, hit_tick=0.5),
    ...
    design("candle_stub", "烛火命中", "普通子弹有概率附着短火。", hit="burn", hit_chance=0.12, hit_damage=1, hit_duration=1.5, hit_tick=0.5),
    ...
    design("oil_lamp", "油火命中", "普通子弹有概率造成较久灼烧。", hit="burn", hit_chance=0.16, hit_damage=1, hit_duration=2.5, hit_tick=0.5),
    ...
    design("ember_leaf", "灰叶火种", "普通子弹有概率点燃敌人。", hit="burn", hit_chance=0.14, hit_damage=1, hit_duration=2.0, hit_tick=0.5),
    ...
    design("ruby_crown", "基础攻击", "攻击力+5。", stack=True, attack=5),
    ...
    design("obsidian_key", "低血处决", "普通子弹有概率处决低生命敌人。", hit="execute", hit_chance=0.16, hit_execute=0.16, hit_cd=0.8),
    ...
    design("void_crown", "虚空处决", "普通子弹有概率处决低生命敌人。", hit="execute", hit_chance=0.22, hit_execute=0.22, hit_cd=0.6),
    design("sun_moon_relic", "技能月盾", "使用技能时生成强月盾。", skill="moon_shield", skill_radius=96.0, skill_duration=10.0),
    design("kingslayer_blade", "弑王处决", "普通子弹有概率强力处决低生命敌人。", hit="execute", hit_chance=0.24, hit_execute=0.28, hit_cd=0.5),
...
ITEMS = [
    ...
    item("campfire_coal", "篝火余烬", COMMON, "coal", "orange", stack=True, attack=1, mdamage=1),
    ...
    item("oil_lamp", "油灯", COMMON, "lamp", "yellow", stack=True, mdamage=1, charge=0.1),
    ...
    item("ruby_crown", "红玉小冠", RARE, "crown", "red", stack=True, attack=5, health=10),
...
def write_config(config: dict[str, Any]) -> None:
    ...
    lines = [
        ...
        '[ext_resource type="Script" path="res://resources/config/pickups/pickup_config.gd" id="2_script"]',
        "",
        "[resource]",
