...
const FORMAL_SCALED_TOTALS := {
	1: [2600, 3850, 3470, 2080, 2100, 2240, 2150, 2240, 3120, 3780, 3000, 4900],
	2: [3250, 4813, 4338, 2602, 2628, 2805, 2692, 2806, 3901, 4725, 3750, 6125],
	4: [4550, 6738, 6073, 3642, 3678, 3924, 3767, 3926, 5461, 6615, 5250, 8575],
	8: [7150, 10588, 9543, 5722, 5778, 6164, 5917, 6166, 8581, 10395, 8250, 13475],
}
const EXPECTED_DAILY_XIRANG: Array[int] = [16330, 39220, 177700]
