...
func _test_elite_config_prewarm() -> void:
	...
	_expect(
		coordinator.ELITE_ENEMY_CONFIG_PATH_BY_BASE_PATH.size() == 10
		and coordinator.elite_enemy_config_by_base_path.size() == 10,
		"All ten fate elite enemy configs must be cached before combat activation."
	)
	_expect(
	...
	_expect(
		...
		"Fate elite replacement map must include the Elite Combat Robot Gunner."
	)
	_expect(
		str(coordinator.ELITE_ENEMY_CONFIG_PATH_BY_BASE_PATH.get(
		...
		"Fate elite replacement map must include the Elite Drone Operator."
	)
	_expect(
		str(coordinator.ELITE_ENEMY_CONFIG_PATH_BY_BASE_PATH.get(
		...
		"Fate elite replacement map must include the Elite Shield Bearer."
	)
	_expect(
		str(coordinator.ELITE_ENEMY_CONFIG_PATH_BY_BASE_PATH.get(
		...
		"Fate elite replacement map must include the Elite Ninja Robot."
	)
	_expect(
		str(coordinator.ELITE_ENEMY_CONFIG_PATH_BY_BASE_PATH.get(
