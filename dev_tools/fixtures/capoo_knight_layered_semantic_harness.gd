...
## Authored Knight state machine with nondeterministic world queries replaced by
## deterministic inputs. All timers, state transitions, RNG, action sequence and
## DamageSourceSnapshot creation remain in production CapooKnight.
