...
func _test_multiplayer_and_runtime_source_contract() -> void:
	...
	_expect(
		...
		(
			"Protocol v77 must gate the generated content digest and isolate same-session participant identities while retaining v74 stale-session CH6 rejection, the v73 session roster, v71 sewer, v69 Vegetation research, v68 six-cell spread, v67 Attack Speed Tower, v66 Speed Tower, v38 projectile, v39 shield-state, v63 resource, "
