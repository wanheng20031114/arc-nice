...
func _test_multiplayer_and_runtime_source_contract() -> void:
	...
	_expect(
		...
		(
			"Protocol v71 must isolate the Underground Sewer normal 20/20/4/3 and emergency 20/2/15/10 compositions, Game04's two spawn points, and the normal/emergency pool contracts while retaining the v70 Underground Church 10/20/40 composition and alive-cap 15 contract, v69 Vegetation research, v68 six-cell spread, v67 Attack Speed Tower, v66 Speed Tower, v38 projectile, v39 shield-state, v63 resource, "
