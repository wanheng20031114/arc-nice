...
func _run() -> void:
	...
	if failures.is_empty():
		print("PROTOCOL_V12_SNAPSHOT_SMOKE_TEST_OK")
		quit()
		return
...
func _test_channel_contract() -> void:
	_expect(NetConstants.PROTOCOL_VERSION == 12, "Protocol must be v12.")
	...
	_expect(
		...
		"Protocol v12 channel assignments must remain stable."
	)
