...
func _run() -> void:
	...
	if failures.is_empty():
		print("PROTOCOL_V34_SNAPSHOT_SMOKE_TEST_OK")
		quit()
		return
...
func _test_channel_contract() -> void:
	_expect(NetConstants.PROTOCOL_VERSION == 34, "Protocol must be v34.")
	_expect(
	...
	_expect(
		...
		"Protocol v34 channel assignments must remain stable."
	)
