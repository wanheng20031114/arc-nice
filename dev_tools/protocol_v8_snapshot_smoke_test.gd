...
func _run() -> void:
	...
	if failures.is_empty():
		print("PROTOCOL_V13_SNAPSHOT_SMOKE_TEST_OK")
		quit()
		return
...
func _test_channel_contract() -> void:
	_expect(NetConstants.PROTOCOL_VERSION == 13, "Protocol must be v13.")
	...
	_expect(
		...
		"Protocol v13 channel assignments must remain stable."
	)
