...
func _run() -> void:
	...
	if failures.is_empty():
		print("PROTOCOL_V41_SNAPSHOT_SMOKE_TEST_OK")
		quit()
		return
...
func _test_channel_contract() -> void:
	_expect(NetConstants.PROTOCOL_VERSION == 41, "Protocol must be v41.")
	_expect(
	...
	_expect(
		...
		"Protocol v41 channel assignments must remain stable."
	)
