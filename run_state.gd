...
const UPGRADE_COSTS := {
	StatType.ATTACK: [90, 270, 450, 720, 1080, 1620, 2250, 3000, 3800, 4700],
	StatType.HEALTH: [45, 70, 90, 180, 450, 720, 1080, 1530, 2070, 2700],
	StatType.ATTACK_SPEED: [45, 70, 90, 180, 450, 720, 1080, 1530, 2070, 2700],
	StatType.DODGE: [45, 70, 90, 180, 450, 720, 1080, 1530, 2070, 2700],
}
