...
@export_range(0.0, 5.0, 0.001, "or_greater") var attack_damage_delay := 0.54
@export_range(0.01, 5.0, 0.001, "or_greater") var attack_slash_duration := 1.1
...
@export_range(0.0, 5.0, 0.01, "or_greater") var skill1_windup := 0.56
...
@export_range(0.0, 5.0, 0.01, "or_greater") var skill1_recovery := 0.78
...
@export_range(0.01, 5.0, 0.01, "or_greater") var skill2_takeoff_duration := 0.46
