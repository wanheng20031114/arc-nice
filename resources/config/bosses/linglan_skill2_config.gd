...
@export_range(0.0, 20.0, 0.05, "or_greater") var rocket_homing_turn_rate: float = 2.4
...
@export_range(0.0, 512.0, 1.0, "or_greater") var rocket_explosion_radius: float = 110.0
