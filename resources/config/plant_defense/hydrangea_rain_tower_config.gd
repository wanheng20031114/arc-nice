...
@export_group("雨幕技能")
@export_range(0.1, 120.0, 0.1, "or_greater") var rain_interval_seconds := 10.0
...
@export_range(0.1, 30.0, 0.1, "or_greater") var attack_reduction_duration_seconds := 3.0
@export_range(1.0, 2048.0, 1.0, "or_greater") var rain_radius := 160.0
...
func is_valid() -> bool:
	return (
		...
		and rain_tick_interval_seconds <= rain_duration_seconds
		...
		and attack_reduction_duration_seconds > 0.0
		and rain_radius > 0.0
	)
